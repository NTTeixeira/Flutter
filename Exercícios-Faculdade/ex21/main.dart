      ...
      children: [
        ...
        Cartao(
          ...
          descricao: 'Lorem Ipsum is simply dummy text of the printing and'
              ...
              'desktop publishing software like Aldus PageMaker including versions of LoremIpsum.',
          preco: 3.10,
          url:
              ...
              children: <Widget>[
                TextButton(
                  ...
                  onPressed: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => RotaGenericaDetalhes(Cartao(
                            titulo: titulo,
                            descricao: descricao,
                            preco: preco,
                            url: url))),
...
class RotaGenericaDetalhes extends StatelessWidget {
  ...
  RotaGenericaDetalhes(this.cartao);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(cartao.titulo),
      ),
      body: Center(
        child: Container(
          padding: EdgeInsets.all(10),
