            ...
            onTap: () => Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => Descricao(
                        'Nova York',
                        'Nova York, EUA',
                        'A cidade de Nova York compreende 5 '
                            'distritos situados no encontro do rio Hudson com o Oceano Atlântico. No centro da cidade fica Ma nhattan, '
                            'um distrito com alta densidade demográfica que está entre os principais centros comerciais, '
                            'financeiros e culturais do mundo (Wikipedia).'))),
          ),
          InkWell(
            child: Padding(
              padding: EdgeInsets.all(8.0),
